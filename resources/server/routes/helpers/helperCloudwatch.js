...
class HelperCloudwatch {                                                                                                                    // Helper class for CloudWatch
    ...
    async deleteAlarmCW (                                                                                                                    // Create a helper method to put data into a cloudwatch metric
        ...
        const command = new DeleteAlarmsCommand(input);                                                                                    // Set the command to put data
    ...
    async getMetricDataCW (metricName, namespace, url) {
        ...
        const input = {                                                                                                                       // Define the input
            ...
            EndTime: moment().subtract(2, "minutes").utc(),                                                                      // Namespace of the Metric
            MetricName: metricName,
            Namespace: namespace,
            Period: 3600,
            StartTime: moment().subtract(7, "days").utc(),
            Dimensions: [
              {
                Name: "URL",
                Value: url,
